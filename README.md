...
* When a hostname exists in the script translation table, the script rewrites the visible text as `hostname (**translation**)` and highlights the hostname in `#1264C8`.
